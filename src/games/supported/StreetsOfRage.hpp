...
#ifndef __STREETS_OF_RAGE_SETTINGS_HPP__
...
class StreetsOfRageSettings : public GenesisSettings {

    public:

		StreetsOfRageSettings();

        // reset
        void reset();

        // the rom-name
        const char* rom() const { return "streets_of_rage"; }
...
#endif // __STREETS_OF_RAGE_SETTINGS_HPP__
