...
#ifndef __STREETS_OF_RAGE_3_SETTINGS_HPP__
#define __STREETS_OF_RAGE_3_SETTINGS_HPP__
...
class StreetsOfRage3Settings : public GenesisSettings {

    public:

		StreetsOfRage3Settings();

        // reset
        void reset();

        // the rom-name
        const char* rom() const { return "streets_of_rage_3"; }
...
#endif // __STREETS_OF_RAGE_3_SETTINGS_HPP__
